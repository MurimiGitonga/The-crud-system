...
<div class="container container-fluid">
    <table class="table">
        ...
        while ($row = $result->fetch_assoc()):
            ...
            <!-- the name in the square brackets is the name of the database -->
            <tr>
...
<div class="container container-fluid">
    <form action="process.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="genre" placeholder="action,drama" type="text" name="genre" value="<?php echo $genre; ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="rate_me">Rate_me</label>
            <input class="form-control" type="text" name="rate_me" value="<?php echo $rate_me;?>">
        </div>
        <div class="form-group">
            <label for="image">Poster Image</label>
            <input class="form-control" id="image" type="file" name="image" value="<?php echo $poster_image;?>">
        </div>
        <?php
        if ($update == true):
            ?>
